...
const ApiTable = ({ apiList }: { apiList: any[] }) => (
  <div>
      ...
      <tbody>
        {apiList.map((api, index) => (
          <tr key={index}>
            ...
            <td className="border border-gray-300 px-4 py-2">{api.apiCd}</td>
            <td className="border border-gray-300 px-4 py-2">{api.apiDesc}</td>
